...
public class Player : NetworkBehaviour
{
    ...
    public async void OnAttackLocal()
    {
        ...
        await Awaitable.WaitForSecondsAsync(DefaultPlayerStatsConfig.Imposter.ATTACK_COOLDOWN);
    ...
    private void TakeDamageServerRpc(float damage = DefaultPlayerStatsConfig.Imposter.DAMAGE, ServerRpcParams serverRpcParams = default)
    {
        if (
    ...
    private async void TakeDamage(float damage)
    {
        ...
        await Awaitable.WaitForSecondsAsync(DefaultPlayerStatsConfig.Player.STUN_DURATION);
