...
namespace Unity.OneInside.Editor
{
    ...
    public class SceneBootstrapper
    {
        ...
        const string k_LoadBootstrapSceneOnPlay = "OneInside/Load Bootstrap Scene On Play";
        const string k_DoNotLoadBootstrapSceneOnPlay = "OneInside/Don't Load Bootstrap Scene On Play";
