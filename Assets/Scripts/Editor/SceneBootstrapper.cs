...
namespace Unity.OneInside.Editor
{
    /// <summary>
    ...
    public class SceneBootstrapper
    {
        ...
        const string k_LoadBootstrapSceneOnPlay = "One Inside/Load Bootstrap Scene On Play";
        const string k_DoNotLoadBootstrapSceneOnPlay = "One Inside/Don't Load Bootstrap Scene On Play";
