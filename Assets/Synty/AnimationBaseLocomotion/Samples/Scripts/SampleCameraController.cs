...
namespace Synty.AnimationBaseLocomotion.Samples
{
    public class SampleCameraController : MonoBehaviour
    {
        ...
        private Synty.AnimationBaseLocomotion.Samples.InputSystem.InputReader _inputReader;
        ...
        private void Start()
        {
            ...
            _inputReader = _syntyCharacter.GetComponent<Synty.AnimationBaseLocomotion.Samples.InputSystem.InputReader>();
